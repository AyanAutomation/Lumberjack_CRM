...
public class SIde_Menu_Handler extends Login{
    ...
    public void Side_menu_option_clicker(String menu_option ,String Submenuoption ) throws IOException, InterruptedException{
    	...
    	if(menu_option.contains("Firm & Counsel")||menu_option.contains("Access Control")&&Submenuoption!=null){
