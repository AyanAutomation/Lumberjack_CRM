...
public class Case_Appplications extends Header_Manager{
	...
	public void Add_case(TreeMap<String, String> data) throws IOException, InterruptedException{
		...
		Thread.sleep(800);
		p.Application_amount_edit_buttons().get(2).click();
	    ...
	    p.popup_modal();
	    Thread.sleep(800);
	    rp.movetoelement(p.popup_modal());
	    Thread.sleep(800);
	    rp.Scroll_to_element(p.Modal_Input_Feilds().get(5));
	    p.Modal_Input_Feilds().get(5).sendKeys(data.get("Document prep fee"));
	    p.Modal_Input_Feilds().get(5).sendKeys(data.get("Fund transfer fee"));
	    rp.Scroll_to_element(p.Modal_Input_Feilds().get(6));
	    rp.Feild_clear(p.Modal_Input_Feilds().get(6));
	    p.Modal_Input_Feilds().get(6).sendKeys(data.get("Rate of Return"));
	    rp.Scroll_to_element(p.Modal_Input_Feilds().get(7));
	    p.Modal_Input_Feilds().get(7).sendKeys(data.get("Agreement Date"));
	    p.calender_date_select().click();
	    p.Modal_Input_Feilds().get(8).sendKeys(data.get("Interest Start Date"));
	    p.calender_date_select().click();
	    p.modal_buttons().get(3).click();
	    p.Contract_editor();
	}
	...
	public Object[][] caseData() {
		...
		c1.put("Agreement Date", "12/10/2025");
		c1.put("Interest Start Date", "12/11/2025");
		c1.put("Buyout Expiry Date", "12/31/2028");
		...
		c2.put("Agreement Date", "12/10/2025");
		c2.put("Interest Start Date", "12/11/2025");
		c2.put("Buyout Expiry Date", "12/31/2028");
		...
		c3.put("Agreement Date", "12/10/2025");
		c3.put("Interest Start Date", "12/11/2025");
		c3.put("Buyout Expiry Date", "12/31/2028");
		...
		c4.put("Agreement Date", "12/10/2025");
		c4.put("Interest Start Date", "12/11/2025");
		c4.put("Buyout Expiry Date", "12/31/2028");
		...
		c5.put("Agreement Date", "12/10/2025");
		c5.put("Interest Start Date", "12/11/2025");
		c5.put("Buyout Expiry Date", "12/31/2028");
		...
		c6.put("Agreement Date", "12/10/2025");
		c6.put("Interest Start Date", "12/11/2025");
		c6.put("Buyout Expiry Date", "12/31/2028");
		...
		c7.put("Agreement Date", "12/10/2025");
		c7.put("Interest Start Date", "12/11/2025");
		c7.put("Buyout Expiry Date", "12/31/2028");
		...
		c8.put("Agreement Date", "12/10/2025");
		c8.put("Interest Start Date", "12/11/2025");
		c8.put("Buyout Expiry Date", "12/31/2028");
		...
		c9.put("Agreement Date", "12/10/2025");
		c9.put("Interest Start Date", "12/11/2025");
		c9.put("Buyout Expiry Date", "12/31/2028");
		...
		c10.put("Agreement Date", "12/10/2025");
		c10.put("Interest Start Date", "12/11/2025");
		c10.put("Buyout Expiry Date", "12/31/2028");
		...
		c11.put("Agreement Date", "12/10/2025");
		c11.put("Interest Start Date", "12/11/2025");
		c11.put("Buyout Expiry Date", "12/31/2028");
		...
		c12.put("Agreement Date", "12/10/2025");
		c12.put("Interest Start Date", "12/11/2025");
		c12.put("Buyout Expiry Date", "12/31/2028");
		...
		c13.put("Agreement Date", "12/10/2025");
		c13.put("Interest Start Date", "12/11/2025");
		c13.put("Buyout Expiry Date", "12/31/2028");
		...
		c14.put("Agreement Date", "12/10/2025");
		c14.put("Interest Start Date", "12/11/2025");
		c14.put("Buyout Expiry Date", "12/31/2028");
		...
		c15.put("Agreement Date", "12/10/2025");
		c15.put("Interest Start Date", "12/11/2025");
		c15.put("Buyout Expiry Date", "12/31/2028");
		...
		c16.put("Agreement Date", "12/10/2025");
		c16.put("Interest Start Date", "12/11/2025");
		c16.put("Buyout Expiry Date", "12/31/2028");
		...
		c17.put("Agreement Date", "12/10/2025");
		c17.put("Interest Start Date", "12/11/2025");
		c17.put("Buyout Expiry Date", "12/31/2028");
		...
		c18.put("Agreement Date", "12/10/2025");
		c18.put("Interest Start Date", "12/11/2025");
		c18.put("Buyout Expiry Date", "12/31/2028");
		...
		c19.put("Agreement Date", "12/10/2025");
		c19.put("Interest Start Date", "12/11/2025");
		c19.put("Buyout Expiry Date", "12/31/2028");
		...
		c20.put("Agreement Date", "12/10/2025");
		c20.put("Interest Start Date", "12/11/2025");
		c20.put("Buyout Expiry Date", "12/31/2028");
