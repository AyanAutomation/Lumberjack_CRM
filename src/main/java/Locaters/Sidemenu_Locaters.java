...
public class Sidemenu_Locaters extends Repeat{
	...
	public List <WebElement> Dropdown_submenu_options(){
	Side_Menu();
	List <WebElement> Dropdown_submenu_options = Side_Menu().findElements(By.xpath(".//li[@role='none']"));
	wait_for_theElement(Dropdown_submenu_options);
	return Dropdown_submenu_options;}/*
	public WebElement (){
	wait_for_theElement();
	return ;}
	public WebElement (){
